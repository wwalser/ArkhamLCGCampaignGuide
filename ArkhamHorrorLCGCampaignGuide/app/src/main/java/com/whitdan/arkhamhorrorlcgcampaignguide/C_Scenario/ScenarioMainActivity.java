    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        continueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (setupRequired) {
                    Toast toast = Toast.makeText(ScenarioMainActivity.this, "You must go through Scenario " +
                            "Setup.", Toast.LENGTH_SHORT);
                    toast.show();
                } else if (investigatorDead) {
                    Toast toast = Toast.makeText(ScenarioMainActivity.this, "Any killed or insane " +
                            "investigators must be removed or replaced.", Toast.LENGTH_SHORT);
                    toast.show();
                } else {
