...
public class CampaignFinishedActivity extends AppCompatActivity {
    ...
    public static class FinishCampaignDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            View v = inflater.inflate(R.layout.d_dialog_finish_campaign, null);
            ...
            okayButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (delete.isChecked()) {
                        ...
                        if (globalVariables.NightCompleted == 1) {
                            Toast toast = Toast.makeText(getActivity(), "You have already completed this campaign.",
                                    Toast.LENGTH_SHORT);
                            toast.show();
                        } else {
                        ...
                        Toast toast = Toast.makeText(getActivity(), "This campaign is not yet available.",
                                Toast.LENGTH_SHORT);
                        toast.show();
                        /*
